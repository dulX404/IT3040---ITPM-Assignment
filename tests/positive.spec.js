...
test('Pos_Fun_0008 - Simple sentence conversion', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
  await page.getByRole('textbox', { name: 'Input Your Singlish Text Here.' }).fill('mama heta gama ta yanavaa.');
  await page.getByText('මම හෙට ගමට යනවා.').click();
});

test('Pos_Fun_0009 - Compound sentence with conjunction', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0010 - Complex sentence with condition', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0011 - Interrogative question form', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0013 - Past tense usage', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0014 - Future tense usage', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
  await page.getByRole('textbox', { name: 'Input Your Singlish Text Here.' }).fill('mama labana awurudde rata yanavaa!');
  await page.getByText('මම ලබන අවුරුද්දෙ රට යනවා!').click();
});

test('Pos_Fun_0015 - Plural subject usage', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0016 - Formal greeting', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0017 - Polite request with marker', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0018 - Informal command with slang', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0019 - Colloquial slang phrase', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0020 - Daily usage expression', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0021 - Standard response', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0022 - Multi-word phrase pattern', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0023 - Repetition for emphasis', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
  await page.getByRole('textbox', { name: 'Input Your Singlish Text Here.' }).fill('hari hari mata eeta therenawa');
  await page.getByText('හරි හරි මට ඒක තේරෙනව').click();
});

test('Pos_Fun_0024 - English abbreviations and short forms', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
  await page.getByRole('textbox', { name: 'Input Your Singlish Text Here.' }).fill('Oyaage NIC number eka mata SMS karanna puluwndha?');
  await page.getByText('ඔයාගෙ NIC number එක මට SMS කරන්න පුලුවන්ද?').click();
});

test('Pos_Fun_0025 - Convert sentences with Negation patterns', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
...
test('Pos_Fun_0026 - Converting Inputs containing punctuation marks', async ({ page }) => {
  await page.goto('https://www.swifttranslator.com/');
  await page.getByRole('textbox', { name: 'Input Your Singlish Text Here.' }).fill('Meeka ahanna! Oyaata bahae ehema karanna.');
